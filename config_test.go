...
func TestUnmarshalBuilderConfigFromYaml(t *testing.T) {
	...
	t.Run("ReturnsCredentialsWithAdditionalProperties", func(t *testing.T) {
		...
		assert.Equal(t, "extensions", config.Credentials[0].AdditionalProperties["path"])
	...
	t.Run("ReturnsTrustedImages", func(t *testing.T) {
		...
		assert.Equal(t, 7, len(config.TrustedImages))
...
func TestMarshalBuilderConfigToJson(t *testing.T) {
	...
	t.Run("ReturnsJsonForOriginalYamlConfig", func(t *testing.T) {
		...
		assert.Equal(t, "{\"credentials\":[{\"name\":\"container-registry-extensions\",\"type\":\"container-registry\",\"additionalProperties\":{\"password\":\"secret\",\"path\":\"extensions\",\"username\":\"username\"}},{\"name\":\"container-registry-estafette\",\"type\":\"container-registry\",\"additionalProperties\":{\"password\":\"secret\",\"path\":\"estafette\",\"username\":\"username\"}},{\"name\":\"gke-estafette-production\",\"type\":\"kubernetes-engine\",\"additionalProperties\":{\"cluster\":\"production-europe-west2\",\"defaultNamespace\":\"estafette\",\"project\":\"estafette-production\",\"region\":\"europe-west2\",\"serviceAccountKeyfile\":\"{}\"}},{\"name\":\"gke-estafette-development\",\"type\":\"kubernetes-engine\",\"additionalProperties\":{\"cluster\":\"development-europe-west2\",\"defaultNamespace\":\"estafette\",\"project\":\"estafette-development\",\"region\":\"europe-west2\",\"serviceAccountKeyfile\":\"{}\"}},{\"name\":\"bitbucket-api-token\",\"type\":\"bitbucket-api-token\",\"additionalProperties\":{\"token\":\"sometoken\"}},{\"name\":\"github-api-token\",\"type\":\"github-api-token\",\"additionalProperties\":{\"token\":\"sometoken\"}},{\"name\":\"slack-webhook\",\"type\":\"slack-webhook\",\"additionalProperties\":{\"webhook\":\"somewebhookurl\"}}],\"trustedImages\":[{\"path\":\"extensions/docker\",\"runDocker\":true,\"injectedCredentialTypes\":[\"container-registry\"]},{\"path\":\"extensions/gke\",\"runDocker\":false,\"injectedCredentialTypes\":[\"kubernetes-engine\"]},{\"path\":\"extensions/bitbucket-status\",\"runDocker\":false,\"injectedCredentialTypes\":[\"bitbucket-api-token\"]},{\"path\":\"extensions/github-status\",\"runDocker\":false,\"injectedCredentialTypes\":[\"github-api-token\"]},{\"path\":\"extensions/slack-build-status\",\"runDocker\":false,\"injectedCredentialTypes\":[\"slack-webhook\"]},{\"path\":\"docker\",\"runDocker\":true,\"injectedCredentialTypes\":null},{\"path\":\"multiple-git-sources-test\",\"runDocker\":false,\"injectedCredentialTypes\":[\"bitbucket-api-token\",\"github-api-token\"]}]}", string(jsonBytes))
	})
}
